...
**BiToHelp** is a blockchain-powered donation platform enabling cryptocurrency donations to verified nonprofits.
...
**File:** `backend/bitohelp_api/views.py`
...
def api_root(request):
    ...
    """
    return JsonResponse({
        'message': 'Welcome to BiToHelp API',
        'version': '1.0.0',
        'endpoints': {
            'health': '/api/health/',
...
**Update:** `backend/bitohelp_api/urls.py`
...
```python
# Add to top of backend/bitohelp_api/settings.py
...
```powershell
# BiToHelp Development Server Starter
...
**Platform:** BiToHelp - Cryptocurrency Donation Platform
